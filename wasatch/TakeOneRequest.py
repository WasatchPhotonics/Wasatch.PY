...
class TakeOneRequest:
    ...
    def __init__(self, take_dark=False, 
                       ...
                       # added to let TakeOneRequest represent a streaming source of "many" (but not infinite) Readings
        ...
        if template is not None:
            ...
            # Not using readings_target/current with templates -- templates are 
            # specifically for a large BatchCollection where multiple individual 
            # TakeOneRequests are being manually generated and tracked.
        else:
